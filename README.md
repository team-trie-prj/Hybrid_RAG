...
> 넣으면 Gemini 3.1 Flash-Lite + 실데이터 + Voyage 임베딩으로 승격된다.
...
src/llm.py                  Gemini 3.1 Flash-Lite function-calling 루프
...
| 규칙 라우터 | Gemini 3.1 Flash-Lite function-calling (GEMINI_API_KEY) |
