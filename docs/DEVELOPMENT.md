...
> LLM: Gemini 3.1 Flash-Lite / 최종 갱신: 2026-06-22
...
src/llm.py                  Gemini 3.1 Flash-Lite function-calling 루프 (google-genai)
...
| 변수 | 용도 | 기본/폴백 |
|---|---|---|
| `GEMINI_API_KEY` (또는 `GOOGLE_API_KEY`) | Gemini 3.1 Flash-Lite 에이전트 | 없으면 규칙 라우터 |
| `GEMINI_MODEL` | 모델 ID 덮어쓰기 | `gemini-3.1-flash-lite` |
